...
def getAverageClassificaionRate(dataset,runs=20,testSize=36,setFunc = setEntropy, infoFunc = infoGain):
    """
...
def testExtraCredit(setFunc = setEntropy, infoFunc = infoGain):
    ...
    print 'Extra Credit (Acute Inflammations Data Set) dataset. Number of examples %d.'%len(examples)
